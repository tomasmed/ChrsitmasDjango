...
DATABASES = {
    ...
    'default': {
        ...
        'USER': 'tomasmed',
        'PASSWORD': 'mysql664',
        'HOST': 'tomasmed.mysql.pythonanywhere-services.com',
         'OPTIONS': {
...
try:
    from . import github_settings, goauthsettings
    SOCIAL_AUTH_GITHUB_KEY = github_settings.SOCIAL_AUTH_GITHUB_KEY
    SOCIAL_AUTH_GITHUB_SECRET = github_settings.SOCIAL_AUTH_GITHUB_SECRET
    SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = goauthsettings.SOCIAL_AUTH_GOOGLE_KEY
    SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = goauthsettings.SOCIAL_AUTH_GOOGLE_SECRET
except:
